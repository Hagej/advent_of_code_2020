...
function main() {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var file, rl, result, rl_1, rl_1_1, line, words, indices, start, end, char, e_1_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    file = fs_1.createReadStream("input.txt", "utf-8");
                ...
                case 3:
                    ...
                    line = rl_1_1.value;
                    words = line.split(" ");
                    indices = words[0].split("-");
                    start = parseInt(indices[0]);
                    end = parseInt(indices[1]);
                    char = words[1].charAt(0);
                    if ((words[2].charAt(start - 1) === char ||
